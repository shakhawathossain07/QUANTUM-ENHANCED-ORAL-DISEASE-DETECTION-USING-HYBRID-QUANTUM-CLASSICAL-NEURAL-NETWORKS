...
**This Project was promised to teach and help through guidance and mentorship under Mahdy Research Academy’s private thesis program  📌 after taking approximately 70,000 BDT, (shared among 6 participants for Part A and Part B); however, 📌 The code implementation and quantum machine learning components were self-learned from Qiskit repositories and were not guided or assisted by the academy. 📌 📌 The initial research idea provided by the academy was AI-generated by the YE.**📌 📌 All coding and writing were carried out independently by the authors (Md. Shakhawat Hossain and Md. Mehedi Hasan), based on publicly available resources including this video tutorial: https://www.youtube.com/watch?v=IohyKm9c4_Q and relevant blog posts, and not by the Academy; modified code retains Apache 2.0 notices and the extended codebase is released under the MIT License.**
